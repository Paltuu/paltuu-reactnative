...
function KeywordFeedScreen() {
  ...
  const {
    ...
    queryKey: ['keyword-feed', word],
    queryFn: ({ pageParam }) => socialApi.getKeywordFeed(word, pageParam as string | null),
  ...
  const postCount = data?.pages[0]?.post_count ?? 0;
...
export default withFocusUnmount(KeywordFeedScreen);
